...
trait ApplicativeError[F[_], E] extends Applicative[F] {
   ...
   */
  def handleError[A](fa: F[A])(f: E => A): F[A] = handleErrorWith[A](fa)(f.andThen[F[A]](pure[A]))
   ...
   * convenience.
   */
  def attemptT[A](fa: F[A]): EitherT[F, E, A] = EitherT.apply[F, E, A](attempt[A](fa))
  ...
  def recoverWith[A](fa: F[A])(pf: PartialFunction[E, F[A]]): F[A] =
    handleErrorWith[A](fa)(e => pf.applyOrElse[E, F[A]](e, raiseError[A]))
  ...
  def adaptError[A](fa: F[A])(pf: PartialFunction[E, E]): F[A] =
    recoverWith[A](fa)(pf.andThen[F[A]](raiseError[A] _))
  ...
  def redeem[A, B](fa: F[A])(recover: E => B, f: A => B): F[B] =
    handleError[B](map[A, B](fa)(f))(recover)
  ...
  def fromOption[A](oa: Option[A], ifEmpty: => E): F[A] =
    oa match {
      case Some(a) => pure[A](a)
      case None    => raiseError[A](ifEmpty)
    }
  ...
  def fromValidated[A](x: Validated[E, A]): F[A] =
    x match {
      case Invalid(e) => raiseError[A](e)
      case Valid(a)   => pure[A](a)
    }
}
...
object ApplicativeError {
  ...
  final private[cats] class LiftFromOptionPartially[F[_]](private val dummy: Boolean = true) extends AnyVal {
    def apply[E, A](oa: Option[A], ifEmpty: => E)(implicit F: ApplicativeError[F, _ >: E]): F[A] =
      oa match {
        case Some(a) => F.pure[A](a)
        case None    => F.raiseError[A](ifEmpty)
      }
  }
