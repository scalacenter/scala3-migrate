...
object RscCompat {
  ...
  object TypesHelpers {
    ...
    val p: fix.explicitResultTypes.RscCompat.TypesHelpers.P = new P
    val c: fix.explicitResultTypes.RscCompat.TypesHelpers.p.C = p.c
    trait A
    trait B
  ...
  class Types[T] extends TypesBase {
    ...
    val typeRef1: fix.explicitResultTypes.RscCompat.TypesHelpers.C = ??? : C
    val typeRef2: fix.explicitResultTypes.RscCompat.TypesHelpers.p.C = ??? : p.C
    val typeRef3: fix.explicitResultTypes.RscCompat.TypesHelpers.E#C = ??? : E#C
    ...
    val singleType1: fix.explicitResultTypes.RscCompat.TypesHelpers.c.type = ??? : c.type
    val singleType2: fix.explicitResultTypes.RscCompat.TypesHelpers.p.c.type = ??? : p.c.type
    ...
    val compoundType2: fix.explicitResultTypes.RscCompat.TypesHelpers.A with fix.explicitResultTypes.RscCompat.TypesHelpers.B = ??? : A with B
    val compoundType3: fix.explicitResultTypes.RscCompat.TypesHelpers.A with fix.explicitResultTypes.RscCompat.TypesHelpers.B{def k: Int} = ??? : A with B { def k: Int }
    val compoundType4: AnyRef{def k: Int} = new { def k: Int = ??? }
    val compoundType5: fix.explicitResultTypes.RscCompat.TypesHelpers.A with fix.explicitResultTypes.RscCompat.TypesHelpers.B = new A with B
    val compoundType6: fix.explicitResultTypes.RscCompat.TypesHelpers.A with fix.explicitResultTypes.RscCompat.TypesHelpers.B{def k: Int} = new A with B { def k: Int = ??? }
    val compoundType7: fix.explicitResultTypes.RscCompat.TypesHelpers.A with scala.collection.immutable.List[_] with fix.explicitResultTypes.RscCompat.TypesHelpers.B = ??? : A with (List[T] forSome { type T }) with B

     val annType1: fix.explicitResultTypes.RscCompat.TypesHelpers.C @fix.explicitResultTypes.RscCompat.TypesHelpers.ann = ??? : C @ann
  ...
  class Bugs {
    ...
    val ti: Types[Int] = ???
    val innerClass1: fix.explicitResultTypes.RscCompat.Types[String]#X = new Types[String]().x
    val innerClass2: fix.explicitResultTypes.RscCompat.Types[Int]#X = ??? : Types[Int]#X
    val innerClass3: Bugs.this.ti.X = ti.x
    val innerClass4: java.util.Base64.Decoder = Base64.getMimeDecoder

    implicit val crazy2: com.twitter.bijection.Bijection[fix.explicitResultTypes.RscCompat.In,fix.explicitResultTypes.RscCompat.Out1] = Bijection.connect[In, Out1](implicit_bijection1)
    val sane1: String = implicitly[String](implicit_y)
    val sane2: com.twitter.bijection.Bijection[fix.explicitResultTypes.RscCompat.In,fix.explicitResultTypes.RscCompat.Out2] = Bijection.connect[In, Out2](implicit_bijection2)

    val t: fix.explicitResultTypes.foo.T = ??? : foo.T
