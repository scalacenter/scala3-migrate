...
object RscCompat {
  ...
  class Bugs {
    ...
    implicit val crazy2: com.twitter.bijection.Bijection[fix.explicitResultTypes.RscCompat.In,fix.explicitResultTypes.RscCompat.Out1] = Bijection.connect[In, Out1]
    val sane1: String = implicitly[String]
    val sane2: com.twitter.bijection.Bijection[fix.explicitResultTypes.RscCompat.In,fix.explicitResultTypes.RscCompat.Out2] = Bijection.connect[In, Out2]
