...
object ExplicitResultTypesImports {
  ...
  val productWithSerializable: scala.collection.immutable.List[Product with migrate.ExplicitResultTypesImports.ADT with java.io.Serializable] = List.apply[Product with ADT with Serializable {}](ADT.A, ADT.B)
  ...
  val longSharedParent1: scala.collection.immutable.List[Product with migrate.ExplicitResultTypesImports.ADT2 with migrate.ExplicitResultTypesImports.Mixin[_ >: String with Int] with java.io.Serializable] = List(ADT2.A, ADT2.B)
  val longSharedParent2: scala.collection.immutable.List[Product with migrate.ExplicitResultTypesImports.ADT2 with migrate.ExplicitResultTypesImports.Mixin[Int] with java.io.Serializable] = List.apply[Product with ADT2 with Mixin[Int] with Serializable {}](ADT2.A, ADT2.C)
